...
class AdminsController < ApplicationController
  ...
  def export
    ...
    wb.add_worksheet(name: "Details") do |sheet|
      # Header row
      sheet.add_row ["Faculty Name", "Semester", "Section", "Academic Year", "Subject Code",
      ...
      sheet.add_row [d.faculty_name, d.semester, d.section, d.academic_year, d.subject_code,
